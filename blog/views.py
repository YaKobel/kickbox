...
def contacti(request):
    return render(request, 'blog/contacti.html', {'title':'Страничка контактов'})

def federation(request):
    return render(request, 'blog/federation.html', {'title':'Страничка федерации'})

def pronas(request):
    return render(request, 'blog/pronas.html', {'title':'Страничка про нас'})

def forum(request):
    return render(request, 'blog/forum.html', {'title':'Страничка форума'})